...
without changing any of your view code! You can see this in action in the
[Meiosis Realworld Example](https://meiosis.js.org/examples/realworld/index.html),
where switching can be achieving just by editing
[one file](https://github.com/foxdonut/meiosis-examples/blob/master/examples/realworld/src/util/view.js).
